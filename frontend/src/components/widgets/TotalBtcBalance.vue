...
<template>
  <div class="card coin-total">
    ...
    <div class="value">
      {{ summary ? formatBtc(summary.total_btc) : "0.00000000 BTC" }}
    </div>
    <div class="sub-value">
      {{ summary ? formatUsd(summary.btc_value_usd) : "N/A" }}
    </div>
    <div class="price-line">
      <span>BTC/USD</span>
      <span class="price">{{
        summary ? formatUsd(summary.btc_price_usd) : "N/A"
      }}</span>
    </div>
  </div>
</template>
